...
def main(args):
    ...
    for fold, (train_indices, val_indices) in enumerate(kfold.split(range(data_size))):
        ...
        for epoch in range(args.epochs):
            ...
            if args.model_name == 'CCNN' or args.model_name == 'PLFA':
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='SED_xLSTM')

    parser.add_argument('--num_models', type=int, default=1)

    # model parameters
    parser.add_argument('--in_c', type=int, default=2)
    parser.add_argument('--patch_size', type=tuple, default=(3, 64))
