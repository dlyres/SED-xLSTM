...
class VisionTransformer(nn.Module):
    def __init__(self, img_size, patch_size, in_c, num_classes,
        ...
        self.patch_embed = embed_layer(img_size=self.img_size, patch_size=self.patch_size, in_c=self.in_c, embed_dim=self.embed_dim)
...
def make_model(args):
    ...
    if  args.dataset_name == 'BETA' or args.dataset_name == 'Benchmark':
        model = VisionTransformer(img_size=(30, 256),
        ...
        model = VisionTransformer(img_size=(8, 256),
                                  patch_size=args.patch_size,
                                  embed_dim=args.embed_dim,
                                  in_c=args.in_c,
                                  depth=args.depth,
