...
def main(args):
    ...
    train_step = 0
    test_step = 0
    final_class_acc = np.zeros(args.num_classes)  # final accuracy
    total_acc_list = []  # total accuracy training trend
    ...
    for epoch in range(args.epochs):
        ...
        if (args.model_name == 'VIT' or args.model_name == 'VGT' or args.model_name == 'SSGFormer'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--isReduceLR', type=bool, default=True)  # if decay
    ...
    # accuracy training trend diagram
